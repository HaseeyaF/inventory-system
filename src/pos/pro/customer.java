...
public class customer extends javax.swing.JPanel {
    ...
    public void search(){
            ...
            try {
                    ...
                    java.sql.Statement s = db.mycon().createStatement();
                    java.sql.ResultSet rs = s.executeQuery(" SELECT * FROM customer WHERE City LIKE '%"+ city +"%' AND Tp_Number LIKE '%"+ tp +"%' AND Contact_Person LIKE '%"+ contact_person +"%' AND Person_Name LIKE '%"+ person_name +"%' ");
    ...
    public void Search_data() {
           // search btn code
                  ...
                  try {
                          ...
                          java.sql.ResultSet rs = s.executeQuery(" SELECT * FROM customer WHERE cid = '"+search+"'");
                          ...
                          if (rs.next()) {
                                  ...
                                  cp_name2.setText(rs.getString("Person_Name"));
    ...
    private void initComponents() {
        ...
        cp_name2 = new javax.swing.JTextField();
        ...
        jLabel8.setText("Customers Info");
        ...
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel13)
                    .addComponent(c_bank, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel11)
                    .addComponent(c_city, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        ...
        cp_name2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cp_name2, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel15)
                    .addComponent(cp_name2, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel16)
                    .addComponent(c_person, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel14)
                    .addComponent(cp_tp, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel17)
                    .addComponent(c_person_email, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel18)
                    .addComponent(cp_online, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(84, 84, 84))
        );
        ...
        sh_pn.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(sh_pn, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(sh_pn, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Customer Name", "T.P Number", "Billing Address", "Shipping Address", "Bank", "City", "Person_Name", "Contact Person", "Person Tp", "Email", "Online"
            }
        ));
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton7, javax.swing.GroupLayout.DEFAULT_SIZE, 301, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel16Layout.createSequentialGroup()
                    ...
                    .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM customer WHERE customer_name LIKE '%"+name+"%' ");
    ...
    private void sh_tpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_tpKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM customer WHERE Tp_Number LIKE '%"+tp+"%' ");
    ...
    private void sh_cityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_cityKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM customer WHERE City LIKE '%"+city+"%' ");
    ...
    private void sh_cpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_cpKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM customer WHERE Contact_Person LIKE '%"+contact_person+"%' ");
    ...
    private void sh_pnKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_pnKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM customer WHERE Person_Name LIKE '%"+person_name+"%' ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String person_name = cp_name2.getText();
        ...
        try {
            ...
            java.sql.Statement s = db.mycon().createStatement();
            s.executeUpdate(" INSERT INTO customer (customer_name,Tp_Number,Billing_Address,Shipping_Address,Bank,City,Person_Name,Contact_Person,Person_tp,email,online) VALUES ('"+name+"','"+tp+"','"+bill_add+"','"+shipp_add+"','"+bank+"','"+city+"','"+person_name+"','"+contact_person+"','"+person_tp+"','"+email+"','"+online+"')");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        */
        ReportView r = null;
        r = new ReportView("src\\reports\\AllCustomers.jasper");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        ReportView r = null;
        r = new ReportView("src\\reports\\CIDCustomer.jasper", para);
        r.setVisible(true);
    ...
    private javax.swing.JTextField cp_name2;
