...
public class supplier extends javax.swing.JPanel {
    ...
    public void search(){
            ...
            String product = sh_pr.getText();
            String position = sh_psn.getText();
            ...
            try {
                    ...
                    java.sql.Statement s = db.mycon().createStatement();
                    java.sql.ResultSet rs = s.executeQuery(" SELECT * FROM supplier WHERE City LIKE '%"+ city +"%' AND Tp_Number LIKE '%"+ tp +"%' AND Product LIKE '%"+ product +"%' AND Position LIKE '%"+ position +"%' ");
    ...
    public void Search_data() {
           // search btn code
                  ...
                  try {
                          ...
                          java.sql.ResultSet rs = s.executeQuery(" SELECT * FROM supplier WHERE sid = '"+search+"'");
                          ...
                          if (rs.next()) {
                                  ...
                                  cp_product.setText(rs.getString("Product"));
    ...
    private void initComponents() {
        ...
        cp_product = new javax.swing.JTextField();
        ...
        sh_pr = new javax.swing.JTextField();
        jLabel6 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        sh_psn = new javax.swing.JTextField();
        ...
        cp_product.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cp_product, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cp_product, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        sh_pr.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        sh_pr.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sh_prActionPerformed(evt);
            }
        });
        sh_pr.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                sh_prKeyReleased(evt);
            }
        });
        ...
        sh_psn.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        sh_psn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sh_psnActionPerformed(evt);
            }
        });
        sh_psn.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                sh_psnKeyReleased(evt);
            }
        });
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(sh_pr, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
                .addGap(18, 18, 18)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
                    .addComponent(sh_psn, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(sh_pr, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(sh_psn, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Supplier Name", "T.P Number", "Billing Address", "Shipping Address", "Bank", "City", "Product", "Position", "Contact Person", "Person Tp", "Email", "Online", "Note"
            }
        ));
        ...
        jTabbedPane1.addTab("Search Supplier", jPanel1);

        jPanel16.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jButton5.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jButton5.setText("All Supplier's Reports");
        ...
        jButton8.setText("Each with detailed");
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addGroup(jPanel17Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton8, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 301, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void c_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_c_search_tblKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM supplier WHERE supplier_Name LIKE '%"+name+"%' ");
    ...
    private void sh_tpKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_tpKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM supplier WHERE Tp_Number LIKE '%"+tp+"%' ");
    ...
    private void sh_cityKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_cityKeyReleased
        ...
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM supplier WHERE City LIKE '%"+city+"%' ");
    ...
    private void sh_prActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sh_prActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sh_prActionPerformed

    private void sh_prKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_prKeyReleased
        // TODO add your handling code here:
        String product = sh_pr.getText();
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM supplier WHERE Product LIKE '%"+product+"%' ");
    ...
    }//GEN-LAST:event_sh_prKeyReleased

    private void sh_psnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sh_psnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sh_psnActionPerformed

    private void sh_psnKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sh_psnKeyReleased
        // TODO add your handling code here:
        String position = sh_psn.getText();
        try {
            ...
            java.sql.ResultSet rs = s.executeQuery("SELECT * FROM supplier WHERE Position LIKE '%"+position+"%' ");
    ...
    }//GEN-LAST:event_sh_psnKeyReleased
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String product = cp_product.getText();
	...
	String note = cp_prnote.getText();
        ...
        try {
            ...
            java.sql.Statement s = db.mycon().createStatement();
            s.executeUpdate(" INSERT INTO supplier (supplier_Name,Tp_Number,Billing_Address,Shipping_Address,Bank,City,Product,Position,Contact_Person,Person_tp,email,online,Private_Note) VALUES ('"+name+"','"+tp+"','"+bill_add+"','"+shipp_add+"','"+bank+"','"+city+"','"+product+"','"+position+"','"+contact_person+"','"+person_tp+"','"+email+"','"+online+"','"+note+"')");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        */
        ReportView r = null;
        r = new ReportView("src\\reports\\AllSupplier.jasper");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        ReportView r = null;
        r = new ReportView("src\\reports\\sidSupplier.jasper", para);
        r.setVisible(true);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
        ReportView r = null;
        r = new ReportView("src\\reports\\aLLSup.jasper");
        r.setVisible(true);
    ...
    private javax.swing.JTextField cp_product;
    ...
    private javax.swing.JTextField sh_pr;
    private javax.swing.JTextField sh_psn;
